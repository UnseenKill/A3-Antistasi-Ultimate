...
#define A3A_Mission(mapName, briefingLocString) \
    class DOUBLES(Antistasi,mapName) { \
        briefingName = briefingLocString; \
        directory = QUOTE(x\A3A\addons\maps\MAPNAME(mapName)); \
    }
...
class CfgMissions {
    class MPMissions {
        ...
        A3A_Mission(australia,"Antistasi Ultimate - Straya");
