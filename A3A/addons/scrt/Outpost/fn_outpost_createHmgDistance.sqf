...
[CBA_EVENT_SERVER_SPAWN_LOCATION, [_markerX, "RebelHmgEmpl", true]] call FUNCMAIN(triggerLocalEvent);
...
[CBA_EVENT_SERVER_SPAWN_LOCATION, [_markerX, "RebelHmgEmpl", false]] call FUNCMAIN(triggerLocalEvent);
