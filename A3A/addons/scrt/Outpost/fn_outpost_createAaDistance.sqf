...
[CBA_EVENT_SERVER_SPAWN_LOCATION, [_markerX, "RebelAaEmpl", true]] call FUNCMAIN(triggerLocalEvent);
...
[CBA_EVENT_SERVER_SPAWN_LOCATION, [_markerX, "RebelAaEmpl", false]] call FUNCMAIN(triggerLocalEvent);
