...
// Logistics nodes for "SUV 4x4" (UK3CB_C_SUV)
...
// Logistics nodes for "SUV 4x4 Armed (M134)" (UK3CB_ION_I_Urban_SUV_Armed)
// Generated by ACNE, the Antistasi Cargo Nodes Editor
class UK3CB_Factions_addons_UK3CB_Factions_Vehicles_wheeled_UK3CB_Factions_Vehicles_suv_uk3cb_suv_armed_p3d : TRIPLES(ADDON,Nodes,Base)
{
    class Nodes
    {
        class Node1
        {
            offset[] = {0,-2.5,-1.38206};
            seats[] = {};
        };

        class Node2
        {
            offset[] = {0,-2.5,-0.970099};
            seats[] = {};
            canCouple = 0;
        };
