...
Debug_3("Vehicle change requested | UID: %1 | Cat: %2 | Vehicle ID: %3", _UID, _catIndex, _vehUID);
...
Debug_3("Vehicle at | Cat: %1 | Vehicle ID: %2 | checked out by UID: %3", _catIndex, _vehUID, _UID);
