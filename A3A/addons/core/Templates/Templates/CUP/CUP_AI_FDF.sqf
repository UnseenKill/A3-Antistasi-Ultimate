...
_militaryLoadoutData set ["vests", ["CUP_V_PMC_CIRAS_OD_Empty", "PLA_VesCUP_V_PMC_CIRAS_OD_Grenadiert_Machinegunner_Wood", "CUP_V_PMC_CIRAS_OD_TL", "CUP_V_PMC_CIRAS_OD_Veh", "CUP_V_PMC_CIRAS_OD_Patrol"]];
